            ...
            <ChampionListPageWrapper>
                <ChampionsWrapper>
                    <div className="header">
                        ...
                        <input id="championInput" type="text" placeholder="챔피언 검색 (가렌, ㄱㄹ, ...)" onChange={this.onChangeSearch} value={this.state.search}/>
                    </div>
                    <div className="list">
                        {
